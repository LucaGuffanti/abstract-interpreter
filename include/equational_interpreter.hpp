    ...
    void manage_block(ASTNode& block, std::shared_ptr<Location<T>> fallback_location = nullptr)
    {
        switch(block.type)
        {
            case NodeType::ASSIGNMENT:
            {
                ...
                assignment_loc->m_store_before = nullptr;
                assignment_loc->m_store_after = nullptr;
            ...
            case NodeType::POST_CON:
            {
                ...
                postcondition_loc->m_store = nullptr;
            ...
            case NodeType::IFELSE:
            {
                ...
                ifelse_loc->m_operation = [ptr = ifelse_loc.get(), this](void) -> void {
                    ...
                    std::cout << "Checking " << var << " " << op << " [" << rhs_interval.lb() << ", " << rhs_interval.ub() << "]" << std::endl; 
                    ...
                    std::cout << "Checking " << var << " " << complementary_op << " [" << rhs_interval_else.lb() << ", " << rhs_interval_else.ub() << "]" << std::endl;
